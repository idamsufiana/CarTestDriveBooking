...
@EnableJpaRepositories(
        ...
        basePackages = {"com.hyundai.booking.CarTestdrive.repository"})
@EntityScan(basePackages = "com.hyundai.booking.CarTestdrive.model.entity")
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean appEntityManagerFactory(final EntityManagerFactoryBuilder builder,
        ...
        return builder
                ...
                .packages("com.ioh.hyundai.booking.CarTestdrive")
                .persistenceUnit("app")
