package com.hyundai.booking.CarTestdrive.config;
...
public class DatasourceConfig {
    ...
    public DataSource appDataSource() {
        ...
        dataSource.setDriverClassName(env.getProperty("spring.datasource.postgres.driver-class-name"));
    ...
    public JdbcTemplate appJdbcTemplate(@Qualifier("app-datasource") DataSource dataSource) {
